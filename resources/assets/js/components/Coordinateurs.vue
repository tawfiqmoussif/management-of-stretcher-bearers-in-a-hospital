<template>
    <div class="container">
        ...
        <div class="col-md-4" >
<h3 style="float:left;" class="card-title">Liste des coordinateurs</h3>
        </div>
        <div class="col-md-4">
 <form class="form-inline">
      <div class="input-group input-group-sm">
        ...
        <div class="col-md-4" >
<button class="btn btn-success" style="float:right;" @click='newModal()'>Ajouter un Coordinateur
...
<script>
    ...
    methods: {
      ...
      console.log("shearchit !");
                   ...
                   getResults(page = 1) {
                        axios.get('api/coordinateur?page=' + page)
                            .then(response => {
  ...
  $('#detailsModal').modal('hide');
    ...
    swal.fire({
     ...
     created() {
      ...
      axios
        .get("api/findCoordinateur?q=" + query)
        .then(data => {
