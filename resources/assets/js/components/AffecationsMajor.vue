            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <div class="row mb-5">
                             <div class="col-md-12">
                      <h3>Les affectations du Service {{intitule_service}}</h3>
                     </div>
...
<table class="calendar table table-bordered " v-show="is_urg===0">
    <thead>
        <tr>
            <th width="9%">&nbsp;</th>
...
<div style="overflow-x:auto;" class="mb-4 mt-4">
<table class="calendar table table-bordered " v-show="is_urg===1">
    <thead>
        <tr>
           <th width="9%">&nbsp;</th>
            <th width="13%">  Lundi </th>
...
return true;
    ...
    loadUrg(){
       axios.get('api/isUrg/').then(({data})=>(
           this.id_service=data[0].id,this.intitule_service=data[0] .intitule,
        data[0].urgence===0 ?  this.is_urg=0: this.is_urg=1,
        this.load_is_urg=true,
