<template>
    <div class="container">
        ...
        <div class="col-md-4" >
<h3 style="float:left;" class="card-title">Liste des Majors</h3>
        </div>
        <div class="col-md-4">
 <form class="form-inline">
      <div class="input-group input-group-sm">
        <input  @keyup="searchit" v-model="searchMaj" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
        ...
        <div class="col-md-4" >
<button class="btn btn-success" style="float:right;" @click='newModal()'>Ajouter un Major
...
editModal(brancardier){
  ...
  $('#detailsModal').modal('hide');
    ...
    swal.fire({
     ...
     created() {
             Fire.$on("searching", () => {
      let query = this.searchMaj;
      axios
        .get("api/findMajor?q=" + query)
        .then(data => {
