...
<head>
  ...
  <title>Brancardage | Espace Brancardier</title>
...
<div class="wrapper" id="app">
  ...
  <!-- Navbar -->
  <master-brancardier :userid="{{auth()->id()}}"></master-brancardier>
  <!-- /.navbar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <router-link to="/affecationsBrancardier" class="nav-link">
              ...
              <li class="nav-item">
                <router-link to="/demandesBrancardier" class="nav-link">
