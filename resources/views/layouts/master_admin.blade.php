...
<head>
  ...
  <title>Brancardage | Espace Admin</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<!-- Font-->
	<link rel="stylesheet" type="text/css" href="/css/affectation/nunito-font.css">
	<link rel="stylesheet" type="text/css" href="/css/affectation/material-design-iconic-font.min.css">
	<!-- Main Style Css -->
  <link rel="stylesheet" href="/css/affectation/style.css"/>
...
<!-- Navbar -->
<vue-master :userid="{{auth()->id()}}"></vue-master>
<!-- /.navbar -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              ...
              &nbsp;<p style="font-size: 14px;">Coordinateurs</p>
              </router-link>
            </li>
            <li class="nav-item">
