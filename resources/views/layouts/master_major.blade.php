...
<head>
  ...
  <title>Brancardage | Espace Major</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/brancardiersMajor" class="nav-link">
            &nbsp;<i class="fas fa-users  #b8c7ce" style="font-size: 14px;"></i>
            <p style="font-size: 14px;">&nbsp;&nbsp;Gestion des brancardiers</p>
              </router-link>
          </li>
          <li class="nav-item">
          <router-link to="/majorService" class="nav-link">
              &nbsp;<i class="fa fa-cogs  #b8c7ce" style="font-size: 14px;"></i>
              <p style="font-size: 14px;">&nbsp;&nbsp;Les informations du service</p>
                </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/affecationsMajor" class="nav-link">
              &nbsp;<i class="fas fa-calendar-check  #b8c7ce" style="font-size: 14px;"></i>
              <p style="font-size: 14px;">&nbsp;&nbsp;Gestion des Affectations</p>
                </router-link>
            </li>
            ...
            <li class="nav-item">
            <router-link to="/declarerdemandemajor" class="nav-link">
              ...
              <li class="nav-item">
                <router-link to="/DemandesMajor" class="nav-link">
                &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-circle-notch #b8c7ce" style="font-size: 8px;"></i>
