...
->where('user_role.role_id','=', '3')->whereNull('users.deleted_at')->where('users.metier','=', 'major')->paginate(3);
    ...
    public function search(){
        ...
        ->join('roles','roles.id','=','user_role.role_id')
        ->where([
            ['user_role.role_id', 'LIKE', '3'],
            ['users.metier', 'LIKE' ,'major'],
            ['nom', 'LIKE', "%$search%"]
    ...
    public function indexP()
    {
        ...
        ->join('user_role','users.id','=','user_role.user_id')
        ->join('roles','roles.id','=','user_role.role_id')
        ->where('user_role.role_id','=', '3')->whereNull('users.deleted_at')->where('users.metier','=', 'major')->get();
